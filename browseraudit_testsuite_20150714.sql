...
COPY category (id, parent, title, description, execute_order, live, in_default, short_description) FROM stdin;
...
7	1	XMLHttpRequest	<p>The same-origin policy applies to the <em>XMLHttpRequest</em> API in a very similar manner to the DOM. That is, a client-side script may only make HTTP requests using the <em>XMLHttpRequest</em> API to the origin it originated from. The key difference when comparing the SOP for <em>XMLHttpRequest</em> to the SOP for DOM is that the <span class="tt">document.domain</span> property has no effect on origin checks for <em>XMLHttpRequest</em>. This means that it is impossible for two cooperating websites to agree for there to be cross-origin requests between them. The other main difference is that Internet Explorer takes the port into account when comparing origins for <em>XMLHttpRequest</em> requests, whereas this is ignored in its SOP checks for DOM access.</p><p>We test the SOP for the <em>XMLHttpRequest</em> API below. We check that requests are allowed when the origins match, and that they are blocked when either the host or scheme does not match. We don't currently test for differing ports.</p>	6	t	t	\N
...
36	11	sandbox	<p>The "sandbox" directive enforces a sandbox policy on iframe elements. It is an optional part of the Content Security Policy 1.0 specification: web browsers are not required to implement it.</p>	11	t	t	\N
...
COPY test (id, title, timeout, behaviour, failure_severity, parent, execute_order, test_function, live) FROM stdin;
...
49	parent: document.domain not set, child: document.domain not set	\N	block	critical	6	1	parentChildSopTest(49, true, true, "https://test.browseraudit.com", "none", "https://browseraudit.com", "none")	t
...
246	object from https://test.browseraudit.com with default-src 'none'	300	block	warning	16	6	cspTest(246, 61, "default-src 'none'", true, { timeout: 300 })	t
247	object from https://test.browseraudit.com with default-src 'self'	300	block	warning	16	7	cspTest(247, 64, "default-src 'self'", true, { timeout: 300 })	t
250	object from https://test.browseraudit.com with object-src 'self'	300	block	warning	16	10	cspTest(250, 65, "default-src 'none'; object-src 'self'", true, { timeout: 300 })	t
254	embed from https://browseraudit.com with object-src 'none'	300	block	warning	16	14	cspTest(254, 59, "default-src 'self'; object-src 'none'", true, { timeout: 300 })	t
...
405	report received	300	block	warning	34	1	cspTest(405, 230, "default-src 'none'; report-uri /csp/pass/230/emptyhtml?sessid="+$.cookie("sessid"), false, { timeout: 300 })	t
...
257	embed from https://test.browseraudit.com with default-src 'self'	300	block	warning	16	17	cspTest(257, 74, "default-src 'self'", true, { timeout: 300 })	t
259	embed from https://test.browseraudit.com with object-src 'none'	300	block	warning	16	19	cspTest(259, 76, "default-src https://test.browseraudit.com; object-src 'none'", true, { timeout: 300 })	t
...
176	frame from remote origin with SAMEORIGIN	\N	block	warning	31	6	frameOptionsTest(176, true, "https://test.browseraudit.com", "SAMEORIGIN")	t
...
172	frame from same origin with SAMEORIGIN	\N	allow	warning	31	2	frameOptionsTest(172, false, "https://browseraudit.com", "SAMEORIGIN")	t
...
35	parent: document.domain = "browseraudit.com", child: document.domain not set	\N	block	critical	4	3	parentChildSopTest(35, true, true, "https://browseraudit.com", "browseraudit.com", "https://test.browseraudit.com", "none")	t
...
37	parent: document.domain = "test.browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	4	5	parentChildSopTest(37, true, true, "https://browseraudit.com", "test.browseraudit.com", "https://test.browseraudit.com", "test.browseraudit.com")	t
42	parent: document.domain not set, child: document.domain = "browseraudit.com"	\N	block	critical	5	2	parentChildSopTest(42, true, false, "https://test.browseraudit.com", "none", "https://browseraudit.com", "browseraudit.com")	t
46	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	5	6	parentChildSopTest(46, false, false, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "browseraudit.com")	t
52	parent: document.domain = "browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	6	4	parentChildSopTest(52, true, true, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "test.browseraudit.com")	t
...
241	object from https://browseraudit.com with default-src 'self'	300	allow	warning	16	1	cspTest(241, 35, "default-src 'self'", false, { timeout: 300 })	t
...
248	object from https://test.browseraudit.com with object-src https://test.browseraudit.com	300	allow	warning	16	8	cspTest(248, 62, "default-src 'none'; object-src https://test.browseraudit.com", false, { timeout: 300 })	t
...
38	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	4	6	parentChildSopTest(38, false, true, "https://browseraudit.com", "browseraudit.com", "https://test.browseraudit.com", "browseraudit.com")	t
43	parent: document.domain = "browseraudit.com", child: document.domain not set	\N	block	critical	5	3	parentChildSopTest(43, true, false, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "none")	t
47	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	5	7	parentChildSopTest(47, false, false, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "browseraudit.com")	t
...
253	embed from https://browseraudit.com with object-src 'self'	300	allow	warning	16	13	cspTest(253, 58, "default-src 'none'; object-src 'self'", false, { timeout: 300 })	t
...
51	parent: document.domain = "browseraudit.com", child: document.domain not set	\N	block	critical	6	3	parentChildSopTest(51, true, true, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "none")	t
53	parent: document.domain = "test.browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	6	5	parentChildSopTest(53, true, true, "https://test.browseraudit.com", "test.browseraudit.com", "https://browseraudit.com", "test.browseraudit.com")	t
54	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	6	6	parentChildSopTest(54, false, true, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "browseraudit.com")	t
56	parent: document.domain = "audit.com", child: document.domain = "audit.com"	\N	block	critical	6	8	parentChildSopTest(56, true, true, "https://test.browseraudit.com", "audit.com", "https://browseraudit.com", "audit.com")	t
...
242	object from https://browseraudit.com with default-src 'none'	300	block	warning	16	2	cspTest(242, 37, "default-src 'none'", true, { timeout: 300 })	t
251	embed from https://browseraudit.com with default-src 'self'	300	allow	warning	16	11	cspTest(251, 56, "default-src 'self'", false, { timeout: 300 })	t
...
175	frame from remote origin with DENY	\N	block	warning	31	5	frameOptionsTest(175, true, "https://test.browseraudit.com", "DENY")	t
177	frame from remote origin with ALLOW-FROM test.browseraudit.com	\N	block	warning	31	7	frameOptionsTest(177, true, "https://test.browseraudit.com", "ALLOW-FROM https://test.browseraudit.com")	t
...
171	frame from same origin with DENY	\N	block	warning	31	1	frameOptionsTest(171, true, "https://browseraudit.com", "DENY")	t
...
30	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	3	6	parentChildSopTest(30, false, false, "https://browseraudit.com", "browseraudit.com", "https://test.browseraudit.com", "browseraudit.com")	t
31	parent: document.domain = "test.browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	3	7	parentChildSopTest(31, true, false, "https://browseraudit.com", "test.browseraudit.com", "https://test.browseraudit.com", "browseraudit.com")	t
39	parent: document.domain = "browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	4	7	parentChildSopTest(39, false, true, "https://browseraudit.com", "browseraudit.com", "https://test.browseraudit.com", "browseraudit.com")	t
40	parent: document.domain = "audit.com", child: document.domain = "audit.com"	\N	block	critical	4	8	parentChildSopTest(40, true, true, "https://browseraudit.com", "audit.com", "https://test.browseraudit.com", "audit.com")	t
41	parent: document.domain not set, child: document.domain not set	\N	block	critical	5	1	parentChildSopTest(41, true, false, "https://test.browseraudit.com", "none", "https://browseraudit.com", "none")	t
44	parent: document.domain = "browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	5	4	parentChildSopTest(44, true, false, "https://test.browseraudit.com", "browseraudit.com", "https://browseraudit.com", "test.browseraudit.com")	t
45	parent: document.domain = "test.browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	5	5	parentChildSopTest(45, true, false, "https://test.browseraudit.com", "test.browseraudit.com", "https://browseraudit.com", "test.browseraudit.com")	t
48	parent: document.domain = "audit.com", child: document.domain = "audit.com"	\N	block	critical	5	8	parentChildSopTest(48, true, false, "https://test.browseraudit.com", "audit.com", "https://browseraudit.com", "audit.com")	t
50	parent: document.domain not set, child: document.domain = "browseraudit.com"	\N	block	critical	6	2	parentChildSopTest(50, true, true, "https://test.browseraudit.com", "none", "https://browseraudit.com", "browseraudit.com")	t
55	parent: document.domain = "test.browseraudit.com", child: document.domain = "browseraudit.com"	\N	allow	critical	6	7	parentChildSopTest(55, true, true, "https://test.browseraudit.com", "test.browseraudit.com", "https://browseraudit.com", "browseraudit.com")	t
...
243	object from https://browseraudit.com with object-src 'self'	300	allow	warning	16	3	cspTest(243, 54, "default-src 'none'; object-src 'self'", false, { timeout: 300 })	t
244	object from https://browseraudit.com with object-src 'none'	300	block	warning	16	4	cspTest(244, 55, "default-src 'self'; object-src 'none'", true, { timeout: 300 })	t
245	object from https://test.browseraudit.com with default-src https://test.browseraudit.com	300	allow	warning	16	5	cspTest(245, 60, "default-src https://test.browseraudit.com", false, { timeout: 300 })	t
249	object from https://test.browseraudit.com with object-src 'none'	300	block	warning	16	9	cspTest(249, 63, "default-src https://test.browseraudit.com; object-src 'none'", true, { timeout: 300 })	t
252	embed from https://browseraudit.com with default-src 'none'	300	block	warning	16	12	cspTest(252, 57, "default-src 'none'", true, { timeout: 300 })	t
255	embed from https://test.browseraudit.com with default-src https://test.browseraudit.com	300	allow	warning	16	15	cspTest(255, 72, "default-src https://test.browseraudit.com", false, { timeout: 300 })	t
256	embed from https://test.browseraudit.com with default-src 'none'	300	block	warning	16	16	cspTest(256, 73, "default-src 'none'", true, { timeout: 300 })	t
258	embed from https://test.browseraudit.com with object-src https://test.browseraudit.com	300	allow	warning	16	18	cspTest(258, 75, "default-src 'none'; object-src https://test.browseraudit.com", false, { timeout: 300 })	t
260	embed from https://test.browseraudit.com with object-src 'self'	300	block	warning	16	20	cspTest(260, 77, "default-src 'none'; object-src 'self'", true, { timeout: 300 })	t
...
173	frame from same origin with ALLOW-FROM browseraudit.com	\N	allow	warning	31	3	frameOptionsTest(173, false, "https://browseraudit.com", "ALLOW-FROM https://browseraudit.com")	t
174	frame from same origin with ALLOW-FROM test.browseraudit.com	\N	block	warning	31	4	frameOptionsTest(174, true, "https://browseraudit.com", "ALLOW-FROM https://test.browseraudit.com")	t
178	frame from remote origin with ALLOW-FROM browseraudit.com	\N	allow	warning	31	8	frameOptionsTest(178, false, "https://test.browseraudit.com", "ALLOW-FROM https://browseraudit.com/")	t
...
36	parent: document.domain = "browseraudit.com", child: document.domain = "test.browseraudit.com"	\N	block	critical	4	4	parentChildSopTest(36, true, true, "https://browseraudit.com", "browseraudit.com", "https://test.browseraudit.com", "test.browseraudit.com")	t
